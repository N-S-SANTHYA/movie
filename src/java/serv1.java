...
public class serv1 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String name=request.getParameter("name");
            ...
            String feedbac=request.getParameter("feedbak");
            Class.forName("com.mysql.jdbc.Driver");
            Connection con;
            con = DriverManager.getConnection("jdbc:mysql://localhost:3306/sse","root","admin");
            Statement stmt=con.createStatement();
            stmt.executeUpdate("insert into message values ('"+name+"','"+mail+"','"+feedbac+"')");
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>THANK YOU FOR YOUR FEEDBACK!!YOU REALLY HELPED US THROUGH!!</h1>");
           ...
           // out.println("<img src='wallpaper-2.jpg' alt='image' background-size='cover'/>");
            out.println("</body>");
            out.println("</html>");/* TODO output your page here. You may use following sample code. */
          /*  out.println("<!DOCTYPE html>");
            out.println("<html>");
            out.println("<head>");
